...
import { pointsChanged, question20Changed } from '../actions/pointsChange';
import axios from 'axios';
import { Alert } from 'react-bootstrap';

const str =
	'20. To reach next level you must know the  ASCII code <-> letter conversion. Clue(97 - a, 65 – A)';
...
class Twenty extends Component {
	...
	update = () => {
		if (
			...
			this.props.question20 === true
		) {
			this.props.question20Changed();
...
const mapStateToProps = state => ({
	...
	question20: state.points.question20
});

export default connect(mapStateToProps, { pointsChanged, question20Changed })(
	withRouter(Twenty)
);
